/**
 * Central icon registry — all SVG icons for the app live here.
 *
 * Interface matches lucide-react's component signature, so migrating is:
 *   export { Pencil as PencilIcon, Copy as CopyIcon, … } from "lucide-react";
 *
 * Every icon accepts:
...
export function SpinnerIcon({ size, className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={size} height={size} className={className}>
