 ...
 *
 * Render rules:
 *   - drawn as <path> with sutle Bezier wobble for hand-drawn feel
 *   - stroke-width 7, opacity 0.92, linecap/join round
 *   - color inherits from the `color` prop (typically team color)
 */
